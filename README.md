...
Inglish: 
A database system designed for a database provided by CFP_17 in Buenos Aires. Only an HTML preview is visible because GitHub does not render PHP or support databases.
